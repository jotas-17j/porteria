...
<div class="flex">
    ...
    <li class="mb-4">
        <a class="flex items-center cursor-pointer hover:bg-gray-700 p-2 rounded transition duration-300" href="../chofer/index.php">
                        ...
                        <table class="min-w-full compact-table">
                            ...
                            if ($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . (isset($row['fecha']) ? $row['fecha'] : 'N/A') . "</td>";
                                    echo "<td>" . (isset($row['entrada']) ? $row['entrada'] : 'N/A') . "</td>";
                                    echo "<td>" . (isset($row['salida']) ? $row['salida'] : 'N/A') . "</td>";
                                    echo "<td>" . (isset($row['entrada2']) ? $row['entrada2'] : 'N/A') . "</td>";
                                    echo "<td>" . (isset($row['salida2']) ? $row['salida2'] : 'N/A') . "</td>";
                                    echo "<td>" . (isset($row['entrada3']) ? $row['entrada3'] : 'N/A') . "</td>";
                                    echo "<td>" . (isset($row['salida3']) ? $row['salida3'] : 'N/A') . "</td>";
                                    echo "<td class='max-w-xs truncate'>" . (isset($row['obs']) ? $row['obs'] : 'N/A') . "</td>";
                                    echo "<td>" . (isset($row['mes']) ? $row['mes'] : 'N/A') . "</td>";
                                    echo "<td>
