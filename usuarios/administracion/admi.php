...
// Verificar si han pasado más de 30 minutos desde la última actividad
...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) &&
    ...
    // Es una petición AJAX, verificar sesión
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item" id="viewTodayRecords" data-section="viewTodayRecordsSection">
                <a href="#" class="d-flex align-items-center">
                    <i class="fas fa-calendar-day me-2"></i>
                    <span>Registros del Día</span>
                </a>
            </li>
            <li class="nav-item" id="viewAllRecords" data-section="viewAllRecordsSection">
                <a href="#" class="d-flex align-items-center">
                    <i class="fas fa-list-alt me-2"></i>
                    <span>Ver Todos los Registros</span>
                </a>
            </li>
            <li class="nav-item" id="searchNav" data-section="searchSection">
                <a href="#" class="d-flex align-items-center">
            ...
            <li class="nav-item">
                <a href="#" class="d-flex align-items-center" onclick="logout(); return false;">
    ...
    <div class="content">
        ...
        <div class="page-header mb-4">
            <h1 class="text-3xl font-bold text-gray-800">
                <i class="fas fa-clipboard-list text-blue-500 me-2"></i>
                Panel de Administración
            </h1>
            <div id="currentView" class="text-gray-600 mt-1">Registros del Día</div>
        </div>

        <!-- Sección de Búsqueda -->
        <div class="section" id="searchSection" style="display:none;" data-title="Búsqueda Avanzada">
            <div class="card">
        ...
        <div class="section" id="viewAllRecordsSection" style="display:none;" data-title="Todos los Registros">
            <div class="card">
                <div class="card-header">
        ...
        <div class="section" id="viewTodayRecordsSection" style="display:none;" data-title="Registros de Hoy">
            <div class="card">
                <div class="card-header">
    ...
    <script>
        // Integrar funciones de navegación
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.nav-item').forEach(item => {
                ...
                if (section) {
                    item.querySelector('a').addEventListener('click', function(e) {
                        ...
                        if (section === 'viewTodayRecordsSection') {
                        ...
                        const title = document.querySelector(`#${section}`).dataset.title;
            ...
            updateActiveNavItem('viewTodayRecords');
            loadTodayRecordsAsync();
            ...
            // Configurar loader global
            window.addEventListener('beforeunload', () => showLoading());
            
            // Manejar errores globales
            window.addEventListener('error', function(e) {
                console.error('Error global:', e.error);
                showMessage('Error', 'Ha ocurrido un error en la aplicación', 'danger');
            });
        });

        // Función para recargar datos periódicamente
        setInterval(() => {
            const currentSection = document.querySelector('.section[style*="block"]');
            if (currentSection && currentSection.id === 'viewTodayRecordsSection') {
                loadTodayRecordsAsync();
            }
